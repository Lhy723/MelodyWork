...
function SettingControl({
  ...
  if (definition.kind === "string-list" || definition.kind === "key-value") {
    ...
    return (
      <textarea
        className="min-h-20 w-64 resize-y rounded-lg border border-input bg-transparent px-2.5 py-2 text-xs outline-none transition-colors placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50"
        onChange={(event) => {
